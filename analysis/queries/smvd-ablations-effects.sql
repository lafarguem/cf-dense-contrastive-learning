...
parameter_rows AS (
    SELECT *,
        CASE
            ...
            THEN 'W/o effects'  -- All true except Disease CF
            ...
            WHEN "pretraining.cfg.pe_cf" = FALSE
                 ...
                 AND "pretraining.cfg.aug.crop" = FALSE
                 AND "pretraining.cfg.aug.jitter" = TRUE
            THEN 'Effects only'  -- All false except Disease CF
        END AS config_label
    FROM ranked
    WHERE rn = 1
...
ORDER BY
    CASE
        ...
        WHEN config_label = 'W/o effects' THEN 2
        WHEN config_label = 'No augmentations' THEN 3
        WHEN config_label = 'Effects only' THEN 4
    END;
