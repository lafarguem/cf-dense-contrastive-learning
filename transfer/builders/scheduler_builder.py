...
class GlobalLossWeightScheduler:
    ...
    def step(self):
        ...
        if self.global_loss_weight == 0.:
            toggle = 'dense'
        elif self.global_loss_weight == 1.:
            toggle = 'global'
        else:
            toggle = 'both'
        self.model.set_toggle(toggle)
        self.i += 1
...
def build_global_loss_weight_scheduler(cfg, model, criterion):
    return GlobalLossWeightScheduler(instantiate(cfg.global_loss_weight_scheduler), model, criterion)